...
export const AipPolygonReadSchema = {
    properties: {
        msid: {
            type: 'integer',
            title: 'Msid'
...
export const PolygonPublicSchema = {
    ...
    type: 'object',
    required: ['title', 'nameofarea', 'msid', 'positionindicator', 'buffer_size', 'id', 'owner_id'],
    title: 'PolygonPublic'
} as const;
